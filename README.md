...
Copy the `framework-cog-smooth-clockwise` directory to:

```text
~/.local/share/plasma/look-and-feel/
```

or install the package through KDE's normal theme/package tools.

Then open:

**System Settings → Appearance → Splash Screen**

and select **Framework Cog — Smooth Clockwise**.
